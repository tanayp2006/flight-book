...
"[project]/app/api/admin/flights/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (destination) where.destination = {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(flights);
}
async function POST(request) {
    ...
    if (!data.flightNumber || !data.originId || !data.destinationId || !data.airlineId || !data.airplaneId || !data.departureTime || !data.arrivalTime || !data.basePrice) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Missing mandatory flight fields'
        }, {
            status: 400
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__87077240._.js.map